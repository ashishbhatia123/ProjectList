				...
				<table class="table">
					<thead>
						<tr >
							...
							<td style="border-bottom: 1px solid #ddd;"><h4 class="product1">Product Size</h4></td>
							<td style="border-bottom: 1px solid #ddd;"><h4 class="product1">Product Price</h4></td>
							<td style="border-bottom: 1px solid #ddd;"><h4 class="product1">Product Discount</h4></td>
							<td style="border-bottom: 1px solid #ddd;"><h4 class="product1">Total Price</h4></td>
						</tr>
					</thead>
					<tbody>
					<c:forEach items="${list}" var="cart_product">
						<tr>
							<td style="border-bottom: 1px solid #ddd;"> <h4 class="product1"><c:out value="${cart_product.prodId}" /> </h4></td>
							<td style="border-bottom: 1px solid #ddd;"><h4 class="product1"><c:out value="${cart_product.name}" /></h4></td>
							<td style="border-bottom: 1px solid #ddd;"><h4 class="product1"><c:out value="${cart_product.sizes}" /> </h4></td>
							<td style="border-bottom: 1px solid #ddd;" ><h4 class="product1"><c:out value="${cart_product.price}" /> </h4></td>
							<td style="border-bottom: 1px solid #ddd;"><h4 class="product1"><c:out value="${cart_product.prodDiscount}" /></h4></td>
							
									
						</tr>
						</c:forEach>
						<tr>
						<td style="border-bottom: 1px solid #ddd;"><h4 class="product1"><td colspan=6 align="right"><c:out value="${totalPrice }"/></h4></td>
						</tr>
					</tbody>
					
				</table>
				<div class="c>!-- ol-md-4"><h4 class="product" style="text-align: right"><td colspan=6 align="right"><c:out value="${totalPrice }"/></h4></div>
			<!-- <div class="col-md-2 col-md-offset-5 btn btn-danger">Place Order</div>	 --> 
			</div>
		<!-- </div> -->
	</div>
